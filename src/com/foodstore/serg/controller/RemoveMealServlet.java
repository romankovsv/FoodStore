...
public class RemoveMealServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			if(meal == null){
				...
				boolean check = MealService.remove(meal);
				if(check == true){
					out.write("<html><body>Meal was successfully deleted from store</body></html>");
				}else{
					out.write("<html><body>Meal was not deleted ERROR</body></html>");
				}
